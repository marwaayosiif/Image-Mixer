...
class Modes(enum.Enum):
    ...
    uniformMagitudeAndPhase = "UniformMagnitudeAndPhase"
    uniformMagitudeAnduniformPhase = "UniformMagnitudeAnduniformPhase"
    uniformPhaseAndMagnitude = "UniformPhaseAndMagnitude"
    uniformPhaseAnduniformMagnitude = "UniformPhaseAnduniformMagnitude"
